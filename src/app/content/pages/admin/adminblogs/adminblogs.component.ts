...
export class AdminblogsComponent implements OnInit {
  ...
  fileChange(event: any) {
    ...
    if (fileList.length > 0) {
      ...
      this.http.post(baseUrl + "api/FileAPI/UploadFiles?inv_no=" + this.selectedContent.sn + "&userid=" + this.selectedContent.sn + 
  ...
  togglePublishImage() {
    ...
    var postUrl = "api/OnlineAppointmentRequestFile/update?id=" + this.selectedImage.id +
  ...
  getPicture() {
    ...
    var demourl = 'api/OnlineAppointmentRequestFile?userid=' + this.selectedContent.sn +
      ...
      '&file_type='+this.content.page_group
    this.http.get(baseUrl + "/api/OnlineAppointmentRequestFile?userid=" + this.selectedContent.sn + 
    "&sn=" + this.selectedContent.sn + "&file_type="+this.content.page_group
      // baseUrl + demourl
      , { headers: { Authorization: 'Bearer ' + token } })
      .subscribe({
